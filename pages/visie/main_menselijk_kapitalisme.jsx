...
const title = `Menselijk kapitalisme` // eslint-disable-line quotes
const subtitle = `Kapitalisme waarbij de mens op één staat.` // eslint-disable-line quotes
const content = [<div key='contentwrapper'><p>Het kapitalisme heeft rond de jaren 80 een flauwe bocht genomen. Vroeger heerste
...
langere termijn niet goed presteren.</p>
<p>Een omgeving van onveiligheid waarin een ontslag zo om de hoek kon liggen zou
...
goed te betalen, maar daarnaast ook belasting af te dragen.</p>
<p>Echter keerde het tij in de jaren 80 onder invloed hoge inflatie en meer
...
maximaliseren van de opbrengst voor de aandeelhouders.</p>
<p>Dit moest gedaan worden door niet alleen de bonussen van CEO’s te koppelen aan
...
worden. Ze was een cijfer op een balans. Ze stond niet op 1.</p>
<p>Het wordt dus hoog tijd om dit te veranderen en bedrijven te stimuleren mensen
...
al jaren zien dat de lonen dalen in ons land.</p>
<p>Toch was het kapitalisme vroeger dus niet zo. Het is gekaapt. Echter zien we
steeds meer bedrijven terugkeren naar de tijd voor deze kaping, door eindelijk
weer de mensen te dienen.</p>
<p>Nu alleen nog een kapitalisme waarin de mensen op een staan.</p>
<p>Wij willen:</p>
<ul>
<li>Belastingvoordelen geven aan bedrijven die werknemers <strong>mede-eigenaar</strong> maken.
...
familie die het bedrijf vanaf dat moment vormt.</li>
<li>Een <strong>menselijk bbp</strong> introduceren met andere factoren dan enkel economische
...
van onze werknemers of goede banen.</li>
<li>Bedrijven meer gaan belasten zodat we de welvaart van Nederland waar ook zij
van profiteren <strong>in stand kunnen houden</strong>.</li>
<li>Vrijheidsdividend van 1.000 euro per maand die werknemers ten eerste meer
...
economie en samenleving als gevolg.</li>
</ul>
