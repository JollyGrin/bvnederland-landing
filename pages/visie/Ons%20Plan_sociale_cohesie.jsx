...
const title = `Sociale Cohesie` // eslint-disable-line quotes
const subtitle = `Onze diversiteit maakt ons sterker.` // eslint-disable-line quotes
const content = [<div key='contentwrapper'><p>Hoe veel vertrouwen er in onze samenleving aanwezig is heeft met alles te maken.
...
belangrijk en ook niet iets wat na licht gestegen koopkrachtplaatjes verandert.</p>
<p>Vertrouwen is namelijk niet iets rationeels wat op cijfers is gericht, maar een
...
leiden dezelfde doelen als ons hebben.</p>
<p>Toch is dit vertrouwen gedaald. In 2017 zeiden 62% van de mensen dat ze
...
sociaal-economische achtergrond van iemand meewegen.</p>
<p>Dit moeten we verbeteren. Zonder dit vertrouwen is het namelijk niet mogelijk
...
begrijpen.</p>
<p>Zonder dit begrip is een voorwaartse samenleving en politiek echter niet
mogelijk. Het is hoog tijd dit vertrouwen terug te winnen. Tijd om de mens eerst
te plaatsen.</p>
<p>Wij willen:</p>
<ul>
<li><strong>Vrijheidsdividend</strong> van 1.000 euro per maand invoeren die het vertrouwen in
onze instituties en tussen Nederlanders zal vergroten.</li>
<li>Investeren in de <strong>leefbaarheid</strong> van krimpgebieden in Nederland</li>
<li>Nederlands <strong>uitwisselprogramma</strong> waarin Nederlandse leerlingen een periode
tijdens schooltijd door het land zullen reizen om in contact te komen met alle
delen van de samenleving</li>
<li><strong>Kunsten</strong> stimuleren</li>
<li>Menselijk bbp waarin we andere factoren in onze samenleving verwerken zoals
levensverwachting, vertrouwen tussen mensen, uren vrijwilligerswerk, mentale
depressies etc.</li>
<li>Vaderschapsverlof verlengen en de <strong>familie</strong> op andere manieren versterken
...
verbeteren van tienduizenden families in Nederland.</li>
</ul>
