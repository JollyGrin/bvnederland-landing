...
const title = `21e-eeuwse economie` // eslint-disable-line quotes
const subtitle = `` // eslint-disable-line quotes
const content = [<div key='contentwrapper'><p>Onze economie groeit al tijden vrij goed. Echter wordt niet meer de vraag
...
uitdagingen en kansen van kunstmatige intelligentie omarmen?</p>
<p>Daarnaast is onze economie nooit helemaal bekomen van de economische crisis in
...
teveel regels de economische dynamiek en investeringen ontmoedigt.</p>
<p>In tijden van crisis moeten we naar elkaar toe trekken als land en mensen juist
...
volgt de economie vanzelf.</p>
<p>Het eerste wat we zullen doen is alle mensen in Nederland een fikse
...
misgaat staan wij voor ze klaar.</p>
<p>Daarnaast is dit vrijheidsdividend belangrijk om onze economie voor te bereiden
...
biedt door tech-hubs zoals Eindhoven te laten groeien.</p>
<p>Wij willen:</p>
<ul>
<li><strong>Vrijheidsdividend</strong> van 1.000 euro per maand voor elke Nederlander om
...
werken omdat werken nu zal lonen.</li>
<li>Voorwaarts <strong>bbp</strong> die menselijke waarden voor economische waarden stelt door
ook onze levensverwachting, mentale gezondheid of het aantal uren
vrijwilligerswerk mee te nemen.</li>
<li>Meer <strong>investeringen</strong> in onze economie stimuleren. Er wordt nu veel te veel
...
gedrag van bedrijven.</li>
<li>Versimpeling belastingstelsel zodat werken weer gaat lonen. Ook willen we
